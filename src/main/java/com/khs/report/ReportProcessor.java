...
public class ReportProcessor {
	...
	public ReportProcessor(ReportFactory factory, ReportIterator iterator) {
		this.factory = factory;
		this.iterator = iterator;
	}

	public ReportIterator getIterator() {
		return iterator;
	}

	public void setIterator(ReportIterator iterator) {
		this.iterator = iterator;
	}
	...
	public List<String[]> process() {
		...
		if (iterator == null)
			throw new RuntimeException("Report iterator instance not set");

		List<Data> data = null;
		while ((data = iterator.nextRow()) != null) {
